...
class LoginTecPage extends StatefulWidget {
  static const String id = 'logintec';

  @override
  _LoginTecPageState createState() => _LoginTecPageState();
}

class _LoginTecPageState extends State<LoginTecPage> {
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  color: Colors.white,
                  child: Text(
                    "Animal Health Technologists Login",
                    style: TextStyle(
                        fontSize: 25.0,
